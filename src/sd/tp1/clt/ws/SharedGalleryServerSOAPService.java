 ...
 * 
 */
@WebServiceClient(name = "SharedGalleryServerSOAPService", targetNamespace = "http://SOAP.svr.tp1.sd/", wsdlLocation = "http://192.168.1.3:9000/FileServerSOAP?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.1.3:9000/FileServerSOAP?wsdl");
