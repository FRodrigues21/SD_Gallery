...
public class ObjectFactory {
    ...
    private final static QName _TestResponse_QNAME = new QName("http://svr.tp1.sd/", "testResponse");
    private final static QName _Test_QNAME = new QName("http://svr.tp1.sd/", "test");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://svr.tp1.sd/", name = "testResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://svr.tp1.sd/", name = "test")
